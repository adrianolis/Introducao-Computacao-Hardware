...
## 2. Vulnerabilidades Técnicas e Humanas

### Vulnerabilidades Técnicas
São fraquezas nos componentes tecnológicos de um sistema:

- **Softwares desatualizados:** sistemas sem patches de segurança aplicados ficam expostos a exploits conhecidos.
- **Senhas fracas ou reutilizadas:** senhas simples (ex.: "123456") são quebradas em menos de 1 segundo por ferramentas de força bruta.
- **Ausência de criptografia:** dados transmitidos ou armazenados sem criptografia podem ser interceptados.
- **Configurações incorretas:** servidores e redes mal configurados expõem serviços que não deveriam ser públicos.
- **Mídias removíveis:** pendrives e HDs externos são vetores frequentes de infecção por malware.

### Vulnerabilidades Humanas
São as mais difíceis de mitigar por envolverem comportamento humano:

- **Falta de conscientização:** usuários que não reconhecem tentativas de phishing ou engenharia social.
- **Negligência:** compartilhar senhas, deixar sessões abertas em computadores públicos ou usar Wi-Fi público para acessar sistemas sensíveis.
...
## 3. Impactos Potenciais em Sistemas e Organizações

| Tipo de Impacto | Descrição |
|---|---|
| **Financeiro** | Multas regulatórias (LGPD), custos de resposta a incidentes, perda de receita |
| **Reputacional** | Perda de confiança de clientes e parceiros, cobertura negativa na mídia |
| **Operacional** | Interrupção de serviços, perda de produtividade, recuperação de sistemas |
| **Legal** | Processos judiciais, notificações obrigatórias a órgãos reguladores |
| **Estratégico** | Vazamento de segredos industriais, perda de vantagem competitiva |
